...
def test_abort_preprocessor(test_consumer):
...
def test_abort_callback(test_consumer):
...
def test_abort_error(test_consumer):
...
def test_abort_postprocess(test_consumer):
